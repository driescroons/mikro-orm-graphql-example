...
export class Migration20200809143205 extends Migration {
    async up(): Promise<void> {
        ...
        this.addSql(
            'create table "author" ("id" uuid not null, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "name" varchar(255) not null, "email" varchar(255) not null, "born" timestamptz(0) null, "favourite_book_id" uuid null);'
        )
